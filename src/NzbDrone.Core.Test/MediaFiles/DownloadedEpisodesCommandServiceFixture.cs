...
namespace NzbDrone.Core.Test.MediaFiles
{
    ...
    public class DownloadedEpisodesCommandServiceFixture : CoreTest<DownloadedEpisodesCommandService>
    {
        ...
        public void should_process_folder_with_downloadclientitem_if_available()
        {
            ...
            Mocker.GetMock<IDownloadedEpisodesImportService>().Verify(c => c.ProcessFolder(It.IsAny<DirectoryInfo>(), It.Is<DownloadClientItem>(v => v != null)), Times.Once());
        }
        ...
        [Test]
        public void should_mark_trackeddownload_as_completed_if_import_succeeded()
        {
            GivenValidQueueItem();
        ...
        [Test]
        public void should_not_mark_trackeddownload_as_completed_if_nothing_was_imported()
        {
            GivenValidQueueItem();
